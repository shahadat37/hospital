<html>
    <head>
        <title></title>
        <script type="text/javascript" $this->lang->lineuage="javascript" src="<?= base_url() ?>js/jquery.dropdownPlain.js"></script>
    ...
    <body>
        ...
        <div class="puchase_report">
            ...
            <table style="border: 0;">
                <thead>
                    <tr><th><?php echo $this->lang->line("id");?></th><th><?php echo $this->lang->line("patient_name");?></th><th><?php echo $this->lang->line("product_treat");?></th><th><?php echo $this->lang->line("bill")." ".$this->lang->line("no");?></th><th><?php echo $this->lang->line("amount");?></th></tr>
                </thead>    
                <tbody>
                    <?php if($reports) {
