					...
					<div class="col-md-12">
						<div class="panel panel-default">
							<div class="panel-heading">
								<strong>Install Hospital Management System: Setup Database</strong>  
							</div>
							...
							<div class="form-group input-group">
								...
								<input type="text" class="form-control" name="dbname" placeholder="Give your database a name" required/>
							</div>
							<div class="form-group input-group">
		...
		<div class="container">
	        <div class="row">
				<div class="col-md-12">
					...
					<h2> Hospital Management System : Install</h2>
        <?php
